    ...
    return (
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title id="contained-modal-title-vcenter" style={{marginLeft: "28%", color: "#415DCC" , padding: "75px"}}>
              <img src={Logo}  style={{position: "absolute", bottom: "95%", left: "45%"}}    />
              <p style={{position: "absolute", top: "120px", right: "30%"}} >POLITICA DE PRIVACIDADE</p>
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <p>
